...
export type SocialIconComponent = ComponentType<SVGProps<SVGSVGElement>>;
...
export function getSocialIcon(name: string): SocialIconComponent {
  return socialIconMap[name] || LinkIcon;
}
